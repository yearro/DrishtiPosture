...
Lee el plan de implementación en `docs/features/{{ feature.slug }}/plan.md`, revisa el issue correspondiente en GitHub y comienza la implementación siguiendo el Task Breakdown de la **Sección 3** del plan en orden secuencial.